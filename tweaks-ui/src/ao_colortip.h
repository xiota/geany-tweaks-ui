...
#define AO_COLORTIP(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), AO_COLORTIP_TYPE, AoColorTip))
#define AO_COLORTIP_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), AO_COLORTIP_TYPE, AoColorTipClass))
#define IS_AO_COLORTIP(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), AO_COLORTIP_TYPE))
#define IS_AO_COLORTIP_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), AO_COLORTIP_TYPE))
