...
#define AO_MARKWORD(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), AO_MARKWORD_TYPE, AoMarkWord))
#define AO_MARKWORD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), AO_MARKWORD_TYPE, AoMarkWordClass))
#define IS_AO_MARKWORD(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), AO_MARKWORD_TYPE))
#define IS_AO_MARKWORD_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), AO_MARKWORD_TYPE))
